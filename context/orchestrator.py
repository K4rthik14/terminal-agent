"""Prompt orchestration for one state-driven LLM request."""
...
class PromptOrchestrator:
    """Runs selectors in order and builds a fresh prompt from ContextState."""
    ...
    def build(self, state: ContextState, available_tools: Iterable[Tool]) -> ContextSelection:
        """Build fresh messages and tool schemas for the current iteration."""
